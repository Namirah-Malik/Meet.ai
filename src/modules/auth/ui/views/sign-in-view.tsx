          ...
          <div className="p-8 md:p-10">
            <div className="flex flex-col gap-6">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <Button
                  type="submit"
                  className="w-full transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] animate-in fade-in slide-in-from-bottom-2 delay-300"
                  disabled={isLoading}
                >
                  {isLoading ? (
                    <>
              ...
              <div className="grid grid-cols-2 gap-4 animate-in fade-in slide-in-from-bottom-2 duration-200 delay-500">
                ...
                >
                  <span className="inline-flex items-center justify-center w-6 h-6 rounded-md bg-white text-slate-800 mr-2">
